...
<div class="filterButtons">
  <a href="index.php?page=filteredRecipes&filter=breakfast"><button class="filterButton">Breakfast</button></a>
  <a href="index.php?page=filteredRecipes&filter=lunch"><button class="filterButton">Lunch</button></a>
  <a href="index.php?page=filteredRecipes&filter=dinner"><button class="filterButton">Dinner</button></a>
  <a href="index.php?page=filteredRecipes&filter=dessert"><button class="filterButton">Dessert</button></a>
</div>
